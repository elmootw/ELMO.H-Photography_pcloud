...
4. 點擊導覽列的 **ELMO.H Photography** 回到首頁相簡列表
5. 點擊導覽列的 **About Me**、**街拍** 或 **風景** 查看獨立分頁

## 📷 添加相簡與照片步驟

### 📌 重要：特殊分頁結構

**About Me**、**街拍** 和 **風景** 有獨立分頁：
- **About Me**：攝影師介紹（獨立分頁）
- **街拍**：連續更新的街拍內容（採用 Masonry 布局）
- **風景**：連續更新的風景內容（採用 Masonry 布局）

這些分頁與首頁的**作品相簡**區分開，提供更清晰的內容組織
...
修改或添加連結示例：
```html
<a href="您的連結" target="_blank" class="social-icon" title="連結名稱">連結名稱</a>
```
...
**Q：為什麼有獨立分頁（About Me、街拍、風景）？**  
A：為了組織內容更清晰：
- **About Me** 提供攝影師介紹
- **街拍** 和 **風景** 是持續更新的內容，獨立展示比與相簡混在一起更優雅
- 所有分頁採用 Masonry 布局提供最佳視覺效果
...
最後更新：2026年2月19日（將 About Me 改成獨立分頁、移除 Hero、Navbar logo 變成導航連結、Blog 改成 Portfolio）
